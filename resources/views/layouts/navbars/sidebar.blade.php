<div class="sidebar" data-color="orange" data-background-color="white" data-image="{{ asset('material') }}/img/sidebar-1.jpg">
  ...
  -->
  <div class="logo">
    <a href="http://localhost/parqueadero/public/" class="simple-text logo-normal">
      {{ __('Panel') }}
    </a>
  </div>
    ...
    <ul class="nav">
      ...
      <li class="nav-item{{ $activePage == 'vehiculo' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('vehiculo.index') }}">
          <i><img style="width:25px" src="{{ asset('material') }}/img/vue.png"></i>         
            <p>{{ __('Vehiculos') }}</p>
        </a>
      </li>
      <li class="nav-item{{ $activePage == 'detalle' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('detalle.index') }}">
          <i><img style="width:25px" src="{{ asset('material') }}/img/react.png"></i>         
