            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="idparqueadero" id="input-name" type="text" placeholder="{{ __('Cupo') }}" value="" required="true" aria-required="true"/>
